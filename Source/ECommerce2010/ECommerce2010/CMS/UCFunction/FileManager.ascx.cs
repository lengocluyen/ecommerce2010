...
namespace ECommerce2010.CMS.UCFunction
{
    public partial class FileManager : System.Web.UI.UserControl
    {
        ...
        {
            this.Label1.Text = DisplayFiles(MyTree.SelectedNode.Value);
        }
        ...
        string DisplayFiles(string location)
        {
            ...
            catch { physicalLocation = location; }
