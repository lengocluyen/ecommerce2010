...
*****************************************************************************/
//constructor for the main Epoch class (VIETNAMESE VERSION BY HYUTARS) Cai tien them mot so thu
...
{
	this.daylist = new Array('CN','T2','T3','T4','T5','T6','T7','CN','T2','T3','T4','T5','T6','T7'); /*<lang:vi>*/
	this.months_sh = new Array('Tháng 1','Tháng 2','Tháng 3','Tháng 4','Tháng 5','Tháng 6','Tháng 7','Tháng 8','Tháng 9','Tháng 10','Tháng 11','Tháng 12');
	this.monthup_title = 'Tháng sau';
	this.monthdn_title = 'Tháng trước';
	this.clearbtn_caption = 'Xóa';
	this.clearbtn_title = '';
	this.maxrange_caption = 'Đây đã là giới hạn';
};
//-----------------------------------------------------------------------------
...
Date.prototype.dateFormat = function(format)
{
	...
	var MONTH_NAMES = new Array('Th�ng M?t','Tháng Hai','March','April','May','June','July','August','September','October','November','December','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec');
	var DAY_NAMES = new Array('Chủ Nhật','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sun','Mon','Tue','Wed','Thu','Fri','Sat');
	format = format + "";
	var result="";
	var i_format=0;
	var c="";
