...
namespace ECommerce2010.Core
{
    public class LibConvert
    {
        ...
        public static decimal ConvertToDecimal(object data, decimal defaultValue)
        {
            return (decimal)ConvertDataType(data, typeof(decimal), defaultValue, System.Globalization.CultureInfo.CurrentCulture);
        }
        //Int
